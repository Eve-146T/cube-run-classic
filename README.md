...
src="fastlane/metadata/android/en-US/images/icon.png" alt="Cube Run Classic">

# Cube Run Classic

Endless runner but you are cube.

Latest APK: [GitHub releases](https://github.com/Eve-146T/cube-run-classic/releases/latest).
...
Cube Run Classic is free software, licensed under the
